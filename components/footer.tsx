    ...
    <footer className="bg-muted py-12 border-t">
      <div className="container px-4 mx-auto">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <h3 className="text-lg font-bold mb-4">Infinity Gains LLP</h3>
            <p className="text-muted-foreground mb-4">
              Empowering your financial future with expert solutions in insurance and mutual funds.
            </p>
            <div className="flex space-x-4">
            <Link href="https://youtube.com/@infinitygainsllp" className="text-muted-foreground hover:text-primary">
